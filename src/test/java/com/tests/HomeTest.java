...
public class HomeTest extends BaseTest {
	...
	@Test(priority = 5)
	public void Verify_Items_Price_Sort_High_To_Low() throws FileNotFoundException, IOException, ParseException, InterruptedException
	{	
		login.Enter_valid_username();
		login.Enter_valid_password();
		login.LoginButtonClick();
	...
	@Test(priority = 6)
	public void Verify_Items_Price_Sort_Low_To_High() throws FileNotFoundException, IOException, ParseException, InterruptedException
	{	
		login.Enter_valid_username();
		login.Enter_valid_password();
		login.LoginButtonClick();
	...
	@Test(priority = 7)
	public void Verify_Items_Name_Order_Acending() throws FileNotFoundException, IOException, ParseException, InterruptedException
	{	
		login.Enter_valid_username();
		login.Enter_valid_password();
		login.LoginButtonClick();
	...
	@Test(priority = 8)
	public void Verify_Items_Name_Order_Decending() throws FileNotFoundException, IOException, ParseException, InterruptedException
	{	
		login.Enter_valid_username();
		login.Enter_valid_password();
		login.LoginButtonClick();
	...
	@Test(priority = 9)
	public void Verify_cart_Icon_Present_or_Not() throws FileNotFoundException, IOException, ParseException, InterruptedException
	{
		login.Enter_valid_username();
		login.Enter_valid_password();
		login.LoginButtonClick();
